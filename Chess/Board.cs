...
namespace Chess
{
    class Board
    {
        public string fen { get; private set; } //эта мразь без паблика не работает
        Figure[,] figures;
        ...
        void Init()
        {
            ...
            // 0 (расположение фигур                       1 2    3 4 5\
            //1-кто ходит 2 флаги ракировки 3 битое поле 4- кол-во ходов 5- номер хода
        ...
        public IEnumerable<FigureOnSquare> VieldFigures()
        {
        ...
        bool CanEatKing()
        {
            ...
            foreach (FigureOnSquare fs in VieldFigures())
            {
